...
//		AddToTrackedPanels();
	...
	void AddToTrackedPanels(){
		if(!panelManager.trackedPanels.Contains(gameObject)){
			panelManager.trackedPanels.Add(gameObject);
		} 
		
//		else if (panelManager.trackedPanels.Contains(gameObject)){
//			panelManager.trackedPanels.Remove(gameObject);
//		}
	}
